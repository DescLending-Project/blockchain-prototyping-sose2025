...
export function TransactionHistory({ contract, account, provider }: TransactionHistoryProps) {
    ...
    const loadTransactionHistory = async () => {
        ...
        try {
            ...
            setError("Failed to load transaction history. Using mock data instead.")
            ...
            const mockTransactions: Transaction[] = [
                {
                    ...
                    hash: '0x1234...5678',
                    description: 'Deposited 100 CORAL as collateral'
                },
                {
                    id: '2',
                    type: 'borrow',
                ...
                },
                {
                    ...
                    description: 'Lent 200 ETH to the pool'
                },
                {
                    id: '4',
                    type: 'interest',
                    ...
                    description: 'Earned 2.5 ETH in interest',
                    interestEarned: '2.5'
                },
                {
                    id: '5',
                    ...
                    hash: '0xabcd...efgh',
                    description: 'Withdrew 25 CORAL collateral'
                }
            ]
