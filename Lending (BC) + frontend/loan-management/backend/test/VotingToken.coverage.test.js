...
describe("VotingToken - Coverage Boost", function() {
    ...
    describe("Voting Power", function() {
        ...
        it("should handle delegation", async function () {
            ...
            // Note: getVotes only returns own balance, not delegated votes
            expect(await votingToken.getVotes(user2.address)).to.equal(30n); // Still own balance
        });
    });
    ...
    describe("Checkpoints", function() {
        it("should create checkpoints on delegation", async function () {
            ...
            expect(await votingToken.delegates(user1.address)).to.equal(user2.address);
            // Note: getVotes still returns own balance, not delegated votes
            expect(await votingToken.getVotes(user1.address)).to.equal(initialBalance);
