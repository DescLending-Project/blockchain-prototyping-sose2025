...
describe("VotingToken - Complete Coverage", function () {
    ...
    describe("Access Control", function () {
        ...
        it("should reject zero address for liquidity pool", async function () {
            await expect(
                votingToken.connect(dao).setLiquidityPool(ethers.constants.AddressZero)
            ).to.be.revertedWith("Invalid address");
        });

        it("should reject zero address for protocol governor", async function () {
            await expect(
                votingToken.connect(dao).setProtocolGovernor(ethers.constants.AddressZero)
            ).to.be.revertedWith("Invalid address");
        });
    });
    ...
    describe("Minting", function () {
        ...
        it("should reject minting to zero address", async function () {
            await expect(
                votingToken.connect(minter).mint(ethers.constants.AddressZero, 50)
    ...
    describe("Standard ERC20 Functions", function () {
        ...
        it("should handle burning", async function () {
            await expect(
                ...
                .withArgs(user1.address, ethers.constants.AddressZero, 20);
