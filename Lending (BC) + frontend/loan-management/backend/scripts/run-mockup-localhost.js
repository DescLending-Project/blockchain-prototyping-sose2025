...
async function main() {
    console.log("🚀 Starting mockup platform behavior simulation on localhost...");
    ...
    console.log("\n🌐 You can now start your frontend with: cd frontend && npm run dev");
}
...
async function getDeployedAddresses() {
    ...
    console.error("Please ensure deployAll.js has been run successfully on localhost.");
