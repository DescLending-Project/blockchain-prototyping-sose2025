...
describe("InterestRateModel", function () {
    ...
    describe("Borrow rate calculation", () => {
        it("calculates below kink", async () => {
            // utilization = 40%
            const util = ethers.toBigInt()	.from("400000000000000000");
            const rate = await model.getBorrowRate(util);
            // rate = base + slope1 * (util / kink)
            const baseRate = ethers.toBigInt()	.from("50000000000000000");
            const slope1 = ethers.toBigInt()	.from("100000000000000000");
            const kink = ethers.toBigInt()	.from("800000000000000000");
            const expected = baseRate.add(slope1.mul(util).div(kink));
            expect(rate.eq(expected)).to.be.true;
        });
        it("calculates at kink", async () => {
            const util = ethers.toBigInt()	.from("800000000000000000");
            const baseRate = ethers.toBigInt()	.from("50000000000000000");
            const slope1 = ethers.toBigInt()	.from("100000000000000000");
        ...
        it("calculates above kink", async () => {
            // utilization = 90%
            const util = ethers.toBigInt()	.from("900000000000000000");
            const baseRate = ethers.toBigInt()	.from("50000000000000000");
            const slope1 = ethers.toBigInt()	.from("100000000000000000");
            const slope2 = ethers.toBigInt()	.from("300000000000000000");
            const kink = ethers.toBigInt()	.from("800000000000000000");
            const one = ethers.toBigInt()	.from("1000000000000000000");
        ...
        it("applies protocol risk adjustment (positive)", async () => {
            ...
            const util = ethers.toBigInt()	.from("500000000000000000");
            const baseRate = ethers.toBigInt()	.from("50000000000000000");
            const slope1 = ethers.toBigInt()	.from("100000000000000000");
            const kink = ethers.toBigInt()	.from("800000000000000000");
        ...
        it("caps rate at maxBorrowRate", async () => {
            // utilization = 100%
            const util = ethers.toBigInt()	.from("1000000000000000000");
            const baseRate = ethers.toBigInt()	.from("50000000000000000");
            const slope1 = ethers.toBigInt()	.from("100000000000000000");
            const slope2 = ethers.toBigInt()	.from("300000000000000000");
            const kink = ethers.toBigInt()	.from("800000000000000000");
            ...
            const maxBorrowRate = ethers.toBigInt()	.from("1000000000000000000");
    ...
    describe("Supply rate calculation", () => {
        it("calculates supply rate correctly", async () => {
            ...
            const one = ethers.toBigInt()	.from("1000000000000000000");
            const reserveFactor = ethers.toBigInt()	.from("100000000000000000");
...
describe("InterestRateModel - Coverage Expansion", function () {
    ...
    it("getWeightedRiskScore returns 0 for all zero tiers", async function () {
        const arr = [0, 0, 0, 0].map(x => ethers.toBigInt()	.from(x));
    ...
    it("getGlobalRiskMultiplier combines multipliers correctly", async function () {
        ...
        expect((await model.getGlobalRiskMultiplier(a, b)).eq(a.mul(b).div(ethers.parseUnits("1", 18)))).to.be.true;
    });
